...
with st.sidebar:
    ...
    if st.button("🔄 Đổi thông tin cá nhân", use_container_width=True):
        for key in ["selected_class", "student_name", "birth_date", "user_key", "messages"]:
...
if "user_key" not in st.session_state:
    ...
    with col2:
        birth_date = st.date_input("Ngày tháng năm sinh (DD/MM/YYYY)", value=datetime(2012, 1, 1).date())
