...
def get_or_create_profile():
    ...
    # Lần đầu: yêu cầu nhập thông tin
    st.subheader("👤 Nhập thông tin cá nhân lần đầu")
    full_name = st.text_input("Họ và tên đầy đủ")
    birth_date = st.date_input("Ngày sinh (DD/MM/YYYY)", value=datetime(2012, 1, 1).date())
    class_name = st.text_input("Lớp của bạn", placeholder="Ví dụ: 6A1, 7B3...")
    role = st.radio("Vai trò", ["Học sinh", "Giáo viên chủ nhiệm"])
